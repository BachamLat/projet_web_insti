...
<head>
    ...
    <title>Liste des demandes de réclamation</title>
...
<body id="page-top">
    ...
    <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            ...
            <div class="container-fluid">
                <div class="d-sm-flex justify-content-between align-items-center mb-4"><label> DEMANDES DE RECLAMATION</label></div>
                <div class="row">
                    <div class="col">
