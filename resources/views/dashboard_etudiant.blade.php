...
<head>
    ...
    <title>Dashboard-Etudiant-INSTI</title>
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid d-flex flex-column p-0"><img class="rounded-circle" src="assets/img/INSTI.png" width="75" height="75">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="/dash_etu"><i class="fas fa-tachometer-alt"></i><span>Tableau de bord</span></a></li>
                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-4">
                                            ...
                                            <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="/faire_demande_reclamation"><span>Faire une demande de réclamation</span>&nbsp;</a></div>
                            ...
                            <div class="card shadow border-left-primary py-2">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col mr-2">
                                            <div class="text-uppercase text-primary font-weight-bold text-xs mb-1"></div>
                                            <a class="btn btn-primary btn-sm d-none d-sm-inline-block" role="button" href="/faire_demande_evaluation"><span>Faire une demande d'evaluation</span>&nbsp;</a></div>
                                        <div class="col-auto"><i class="fas fa-envelope-open-text fa-2x text-gray-300"></i></div>
                                    </div>
                                </div>
                            </div>
